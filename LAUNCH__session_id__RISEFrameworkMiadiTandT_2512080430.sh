#!/bin/bash
. _env.sh
export SESSION_ID=cbc5c7eb-5992-4a17-8fbe-563207c74bb4
export session_id__RISEFrameworkMiadiTandT_2512080430
export session_id__RISEFrameworkMiadiTandT_2512080430__MCP_CONFIG
